...
| 2 | W2-3 audit coverage gaps AUD-P06/05/07 | worker-5 | rulings issued (decision #7: AUD-P07 trimmed to presented-cookie 401s; audit-union prune CREATE/DELETE/SYNC_PUBLIC with UPDATE staying — single types.ts edit; CONTENT_* migration plan). Doc 10 v1.4.0 round in flight; code phase next (owner worker-5; server.ts lane queues behind W2-5) |

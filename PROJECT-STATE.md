...
| 2 | DCR-9 code phase (Option C UI) | worker-4 | IN FLIGHT (task #19): src/-only — remove publish-promising toggles + response-discard/fabricated-log fixes + "Withdraw from public" row action riding PUT forced-reset; gates tsc --strict/build/smoke 99/e2e; verification by worker-1 queued |
